...
def mDeeplab(weights='pascal_voc', input_tensor=None, input_shape=(320, 240, 3), classes=1, backbone='mobilenetv2', OS=8, alpha=0.5):
...
model.compile(optimizer=optim,loss='binary_crossentropy',metrics=[iou])
history=model.fit_generator(train_data,steps_per_epoch=steps,epochs=22,use_multiprocessing=True, verbose=2,workers=4,
...
keras.models.save_model(model,'dm05.h5',include_optimizer=False)
...
model=keras.models.load_model('best_model.h5',{'iou':iou})
